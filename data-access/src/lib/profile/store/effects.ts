...
import {  selectProfilePageable, selectSaveFilteredProfiles } from '@tt/data-access/profile';
...
export class ProfileEffects {
  ...
  getSubscribers = createEffect(() => {
    return this.actions$.pipe(
      ...
      map((subscribers) => profileActions.subscribersLoaded({ profiles: subscribers.items }))
    )
  })
